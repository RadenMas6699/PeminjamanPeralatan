...
public class AdminFragLabInstalasi extends Fragment {

    private DatabaseReference reffLabInstalasi;
    private ShimmerFrameLayout shimmer_frag;
    private final String path = "Lab_Instalasi";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv_lab_instalasi = view.findViewById(R.id.rv_lab);
        ...
        reffLabInstalasi = FirebaseDatabase.getInstance().getReference(path);
        reffLabInstalasi.keepSynced(true);

        rv_lab_instalasi.setHasFixedSize(true);
        rv_lab_instalasi.setLayoutManager(new LinearLayoutManager(getContext()));

        options = new FirebaseRecyclerOptions.Builder<DataRecycler>().setQuery(reffLabInstalasi, DataRecycler.class).build();
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.popup_delete:
                                ...
                                new AlertDialog.Builder(getContext())
                                        ...
                                        .setPositiveButton("Ya", (dialogInterface, i1) -> reffLabInstalasi.child(dataRecycler.getId_tool()).removeValue().addOnCompleteListener(task -> {

                                            //hapus realtime database
                                            Query query = reffLabInstalasi.orderByChild("id_tool").equalTo(dataRecycler.getId_tool());
        ...
        setEmptyState.emptyState(reffLabInstalasi, shimmer_frag, lottieEmpty, tvEmptyState);

        rv_lab_instalasi.setAdapter(adapter);
