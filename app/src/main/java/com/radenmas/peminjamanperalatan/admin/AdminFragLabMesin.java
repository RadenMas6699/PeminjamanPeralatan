...
public class AdminFragLabMesin extends Fragment {

    private DatabaseReference reffLabMesin;
    private ShimmerFrameLayout shimmer_frag;
    private final String path = "Lab_Mesin";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reffLabMesin = FirebaseDatabase.getInstance().getReference(path);
        reffLabMesin.keepSynced(true);

        RecyclerView rv_lab_mesin = view.findViewById(R.id.rv_lab);
        ...
        options = new FirebaseRecyclerOptions.Builder<DataRecycler>().setQuery(reffLabMesin, DataRecycler.class).build();
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.popup_delete:
                                new AlertDialog.Builder(getContext())
                                        ...
                                        .setPositiveButton("Ya", (dialogInterface, i1) -> reffLabMesin.child(dataRecycler.getId_tool()).removeValue().addOnCompleteListener(task -> {

                                            //hapus realtime database
                                            Query query = reffLabMesin.orderByChild("id_tool").equalTo(dataRecycler.getId_tool());
